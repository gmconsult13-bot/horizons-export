    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-grow py-16">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold mb-10 text-foreground text-center">Review Your Booking</h1>

          <div className="bg-card p-8 rounded-2xl shadow-sm border border-border space-y-8">
            <div>
              <h2 className="text-2xl font-semibold mb-4">Stay Details</h2>
            ...
            <div className="flex gap-4 pt-4">
              <Button variant="outline" className="w-full" onClick={() => navigate(-1)}>Back to Edit</Button>
              <Button className="w-full" onClick={() => navigate('/booking/checkout', { state: location.state })}>Proceed to Payment</Button>
            </div>
          </div>
        </div>
      </main>
